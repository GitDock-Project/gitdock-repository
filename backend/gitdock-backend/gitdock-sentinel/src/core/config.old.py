...
class Settings(BaseSettings):
    ...
    eureka_server_url: str = os.getenv("EUREKA_SERVER_URL", "http://100.120.192.92:8761/eureka/")
    ...
    rabbitmq_host: str = os.getenv("RABBITMQ_HOST", "100.120.192.92")
    rabbitmq_port: int = int(os.getenv("RABBITMQ_PORT", 5672))
    rabbitmq_user: str = os.getenv("RABBITMQ_USER", "guest")
    rabbitmq_password: str = os.getenv("RABBITMQ_PASSWORD", "guest")

    # LLM & Embeddings
    ollama_api_url: str = os.getenv("OLLAMA_API_URL", "http://100.89.63.25:11434")
