...
class Settings(BaseSettings):
    ...
    eureka_server_url: str = Field(default="http://100.120.192.92:8761/eureka/", env="EUREKA_SERVER_URL")
    ...
    rabbitmq_host: str = Field(default="100.120.192.92", env="RABBITMQ_HOST")
    ...
    ollama_api_url: str = Field(default="http://100.89.63.25:11434", env="OLLAMA_API_URL")
